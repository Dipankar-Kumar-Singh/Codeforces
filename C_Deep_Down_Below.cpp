...
signed main()
{
    ...
    t_case
    {
      ...
      //  tv(mon,v,ll) ;
        ...
        int mx = 0 ; 
        int idx = 0 ;  // index of cave which is hardest to beat 
        ...
        cfl(0,n-1,j){
            vii v1 ; 
            cin >> mon ;
            int sum_of_cur_vec = 0 ;
            fl(0,mon-1)
            {  int x ; cin >> x ; v1.pb({x,i}) ; 
            ...
            h[j] = sum_of_cur_vec ;   // hash of sum of vecs 
            v.pb(v1) ; 
        }
      ...
      //  if(n==2){ }
       ...
       int Hardest_cave_id =  *max_element(all(h)) ; ;

       if(n==1)
       {
           vii cave = v[0] ;
           vi cv ;
           fl(0,cave.size()-1){ cv.pb(cave[i].F)  ;}
           int power_gained = id(mx,cv) ;
           
           auto req = mx+1 - power_gained ;
           // if req --> -1  negative ;
           // then it mean we alredy reached the req thrash hold,
       ...
       else
       {
           ...
           int sssssummm {} ;
            ...
            power_gained += sssssummm - h[cave_to_tackel];
         //   error(power_gained,h[cave_to_tackel], sssssummm) ;
        ...
        //    }
           ...
           auto cave = v[idx]  ;  //vii
            ...
            power_gained += id(mx,cv) ;

            int req = mx+1 - power_gained ;
