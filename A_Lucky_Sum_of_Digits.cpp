...
signed main()
{
    ...
    if((n<4) || (n>4 and n<7)){cout << -1 ; return 0 ; }
        ...
        {    str s2 = "7777" ;
             ...
             ff(x){s.pb('4');} cout << s ; return 0 ; 
        }

    else if(n%4==3 and n-7>=0){
